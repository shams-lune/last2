...
async def codecreateur(ctx):
	...
	embed.add_field(name="Tuto comment mettre le code créateur", value="https://clips.twitch.tv/CulturedResourcefulNuggetsFutureMan-JrAs4TWCyd33Fbll", inline=True)
        await ctx.send(embed=embed)
